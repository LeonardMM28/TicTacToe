function TicTacToe(placehold, grid_size, callback) {
...
TicTacToe.prototype.paint = function (grid_size) {
  ...
  self.placehold.innerHTML = html;

  // Find all columns
  self.columns = self.placehold.getElementsByTagName("td");
...
var tictactoe = new TicTacToe(placehold, 3, onResult);
